    ...
    <div>
      ...
      <div className="my-16 w-[90%] gap-8 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mx-auto">
        {classes.map((cls, index) => (
          <div
            key={index}
            className={` hover:-translate-y-2  duration-150 hover:ring-[2px] hover:ring-secondary w-64 h-80 mx-auto ${
          ...
          >
            <div className=" h-48">
              <div
                className={` inset-0 bg-black opacity-0 transition-opacity duration-300 ${
              ...
              <div className="flex items-center justify-between mt-4">
                ...
                <div className=" flex items-center justify-center">
                  <button
                    ...
                    className="px-4 py-2 mb-20 text-white disabled:bg-red-300 bg-secondary duration-300 rounded hover:bg-red-700"
                  >
                    Select
                  </button>
                </div>
