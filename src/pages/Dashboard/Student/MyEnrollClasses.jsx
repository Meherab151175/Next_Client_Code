...
const MyEnrolledClasses = () => {
    ...
    if (loading) { // [2
        return <div className='h-full w-full flex justify-center items-center'><SyncLoader color="#FF1949" /></div>;
    }
    return (
        <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                {
                    pagedData.map(item => <div key={item.classes._id + v4()} className="
                bg-white
                shadow-md
                h-96
                mx-3
