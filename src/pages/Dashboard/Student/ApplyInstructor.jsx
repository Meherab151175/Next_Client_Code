...
const ApplyInstructor = () => {
    ...
    return (
        <>
                ...
                <AnimatePresence>
                    {submitData?.name && (
                        ...
                        >
                            ...
                            <p className="text-lg font-semibold">Name: {submitData?.name}</p>
                            <p className="text-lg font-semibold">Email: {submitData?.email}</p>
                            <p className="text-lg font-semibold">Experience: {submitData?.experience}</p>
            ...
            {
                submitData?.reject && <div className="">
